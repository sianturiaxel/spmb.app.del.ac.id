...
$dataUrl = Url::to(['nilai-akademik/data-for-datatables']);
$createUrl = Url::to(['create']);
$uploadUrl = Url::to(['nilai-akademik/upload']);
...
<div class="card">
    <div class="card-body">
        <div class="card-body">
            <form id="excel-upload-form" method="post" enctype="multipart/form-data" action="<?= Url::to(['nilai-akademik/upload']) ?>">
                <?= Html::hiddenInput(Yii::$app->request->csrfParam, Yii::$app->request->csrfToken) ?>
                <div class="custom-file">
                    <input type="file" class="custom-file-input" name="NilaiAkademik[excelFile]" accept=".xls,.xlsx" required>
