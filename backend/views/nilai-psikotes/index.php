...
/** @var backend\models\NilaiPsikotesSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */
$dataUrl = Url::to(['nilai-psikotes/data-for-datatables']);
$createUrl = Url::to(['create']);
$uploadUrl = Url::to(['nilai-psikotes/upload']);
...
$(document).ready(function() {
    ...
    $('div.toolbar').html('<a href="$createUrl" class="btn btn-success">Tambah Data Nilai Psikotes</a>');
});
JS;
...
<div class="card">
    <div class="card-body">
        <div class="card-body">
            <form id="excel-upload-form" method="post" enctype="multipart/form-data" action="<?= Url::to(['nilai-psikotes/upload']) ?>">
                <?= Html::hiddenInput(Yii::$app->request->csrfParam, Yii::$app->request->csrfToken) ?>
                <div class="custom-file">
                    <input type="file" class="custom-file-input" name="NilaiPsikotes[excelFile]" accept=".xls,.xlsx" required>
