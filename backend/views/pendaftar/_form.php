...
>>>>>>> 6d807d99a78098a7485130a146d84503a1f32f36
            ...
            <div class="card-body" id="data-adminstrasi" style="display: none;">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <?= $form->field($model, 'fileFoto')->fileInput()->label('File Foto') ?>
                    </div>
                    <div class="col-md-10">
                        <?php if (!empty($model->pas_foto)) : ?>
                            <p>File saat ini: <a href="<?= Yii::getAlias('@web') . '/uploads/' . Html::encode($model->pas_foto) ?>" target="_blank">Download</a></p>
                        <?php else : ?>
                            <p>No file chosen</p>
                        <?php endif; ?>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <?= $form->field($model, 'fileNilaiRapor')->fileInput()->label('File Nilai Rapor') ?>
                    </div>
                    <div class="col-md-10">
                        <?php if (!empty($model->file_nilai_rapor)) : ?>
                            <p>File saat ini: <a href="<?= Yii::getAlias('@web') . '/uploads/' . Html::encode($model->file_nilai_rapor) ?>" target="_blank">Download</a></p>
                        <?php else : ?>
                            <p>No file chosen</p>
                        <?php endif; ?>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <?= $form->field($model, 'fileSertifikat')->fileInput()->label('File Sertifikat') ?>
                    </div>
                    <div class="col-md-10">
                        <?php if (!empty($model->file_sertifikat)) : ?>
                            <p>File saat ini: <a href="<?= Yii::getAlias('@web') . '/uploads/' . Html::encode($model->file_sertifikat) ?>" target="_blank">Download</a></p>
                        <?php else : ?>
                            <p>No file chosen</p>
                        <?php endif; ?>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <?= $form->field($model, 'fileFormulir')->fileInput()->label('File Formulir') ?>
                    </div>
                    <div class="col-md-10">
                        <?php if (!empty($model->file_formulir)) : ?>
                            <p>File saat ini: <a href="<?= Yii::getAlias('@web') . '/uploads/' . Html::encode($model->file_formulir) ?>" target="_blank">Download</a></p>
                        <?php else : ?>
                            <p>No file chosen</p>
                        <?php endif; ?>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <?= $form->field($model, 'fileRekomendasi')->fileInput()->label('File Rekomendasi') ?>
                    </div>
                    <div class="col-md-10">
                        <?php if (!empty($model->file_rekomendasi)) : ?>
                            <p>File saat ini: <a href="<?= Yii::getAlias('@web') . '/uploads/' . Html::encode($model->file_rekomendasi) ?>" target="_blank">Download</a></p>
                        <?php else : ?>
                            <p>No file chosen</p>
                        <?php endif; ?>
                    </div>
